...
public class PersonServiceImpl extends BaseElasticsearchService implements PersonService {
    ...
    @Override
    public void insert(String index, List<FreeCitizen> list) {
    ...
    @Override
    public void update(String index, List<FreeCitizen> list) {
        list.forEach(person -> {
    ...
    @Override
    public void delete(String index, FreeCitizen person) {
    ...
    @Override
    public List<FreeCitizen> searchList(String index) {
        SearchResponse searchResponse = search(index);
        SearchHit[] hits = searchResponse.getHits().getHits();
        List<FreeCitizen> personList = new ArrayList<>();
        Arrays.stream(hits).forEach(hit -> {
            Map<String, Object> sourceAsMap = hit.getSourceAsMap();
            FreeCitizen person = BeanUtil.mapToBean(sourceAsMap, FreeCitizen.class, true);
